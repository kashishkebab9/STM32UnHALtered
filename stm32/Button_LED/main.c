...
int main(void)
{
  ...
  // This register allows you to tell the microcontroller which I/O devices/ peripherals you want to enable the clock for
  // The reason why not all Clocks are enabled by default is to not have unused power
